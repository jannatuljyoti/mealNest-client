...
const AllMeals = () => {
  ...
  return (
    <div className="p-4 sm:p-6 bg-base-100">
      <h2 className="text-xl sm:text-2xl font-bold mb-5 text-center">All Meals</h2>
      ...
      <div className="flex flex-col sm:flex-row gap-3 mb-4 justify-center">
        <select
          ...
          className="bg-base-100 border px-3 py-2 rounded"
        >
      ...
      <div className="overflow-x-auto">
        <table className="table-auto min-w-[600px] w-full border border-gray-300 rounded">
            ...
            {allMeals.map((meal) => (
              <tr key={meal._id} className="border-t">
                ...
                <td className="p-2 flex flex-wrap gap-2">
                  <button
                    className="btn btn-xs sm:btn-sm bg-[#ec644b] text-white"
                  ...
                  {editingMealId === meal._id ? (
                    ...
                    <button
                      className="btn btn-xs sm:btn-sm bg-green-700 text-white"
                  ...
                  <button
                    className="btn btn-xs sm:btn-sm bg-[#0c6c7c] text-white"
          ...
          <button
            ...
            className={`btn btn-sm ${
              currentPage === num + 1
                ...
                : 'bg-[#0c6c7c] text-white btn-outline'
            }`}
          >
            {num + 1}
          </button>
